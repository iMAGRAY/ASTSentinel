...
mod integration_tests {
    ...
    fn test_actual_full_context_output() {
        ...
        assert!(result.contains("function test()"), "Should contain function declaration");
        assert!(result.contains("console.log(\"line 1\")"), "Should contain unchanged line");
        assert!(result.contains("-     console.log(\"line 2\")"), "Should show removed line");
        assert!(result.contains("+     console.log(\"MODIFIED LINE\")"), "Should show added line");
    ...
    fn test_large_file_truncation() {
        ...
        println!("Result contains truncation warning: {}", result.contains("truncated"));
